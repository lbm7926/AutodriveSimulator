...
namespace Simulator.Map
{
    ...
    public class MapLane : MapDataPoints, IMapLaneLineCommon<MapLane>, IMapType
    {
        ...
        public void DrawEvent()
        {
            ...
            {
                GameObject lanePoint = Instantiate(Resources.Load("LanePoint")) as GameObject;
                lanePoint.transform.position = mapLocalPositions[i];
                lanePoint.transform.SetParent(transform);
            }
            GameObject line = Instantiate(Resources.Load("LineModel") as GameObject);
            line.transform.SetParent(transform);
            LineRenderer lineRenderer = line.GetComponent<LineRenderer>();

            lineRenderer.startWidth = 0.1f;
            lineRenderer.endWidth = 0.1f;
            lineRenderer.positionCount = mapLocalPositions.Count;
            lineRenderer.SetPositions(mapLocalPositions.ToArray());
            lineRenderer.material = Resources.Load("Line") as Material;
